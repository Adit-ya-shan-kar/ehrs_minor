        ...
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfl tp-resizeme" 
                ...
                data-endspeed="300"
                style="z-index: 5; font-size:50px; font-weight:500; color:black;  max-width: auto; max-height: auto; white-space: nowrap;">GET WELL HOSPITALS</div>
          ...
          <div class="row"> 
            ...
            <div class="col-md-8">
              <div class="text-sec">
                ...
                <p>Besides providing world class clinical lab services, we house a pool of doctors of different medical specialty to serve the ailing patients as outpatients. They are all reputed and respected in their medical specialty for outstanding clinical management</p>
                <ul class="row">
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> EMERGENCY CASE</h6>
                    <p>Rapid, expert care, ensuring patients receive life-saving treatment
                       during critical moments of need. </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> QUALIFIED DOCTORS</h6>
                    <p>Our hospital boasts a team of highly skilled doctors, dedicated to 
                      delivering exceptional care with expertise and compassion. </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> ONLINE APPOINTMENT</h6>
                    <p>Effortlessly schedule your medical appointments online with our 
                      convenient and user-friendly hospital appointment service. </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> FREE MEDICAL COUNSELING</h6>
                    <p>Access professional guidance and support with our complimentary 
                    medical counseling service, offering confidential assistance to all. </p>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="row"> 
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>Experience exceptional care and precision with our dedicated team of eye specialists.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  <h6>Operation Theatre</h6>
                  <p>Our state-of-the-art operation theatre ensures the highest standards of safety and care for all surgical procedures.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>Receive intensive, round-the-clock care from our expert medical team in our advanced ICU department.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>Trust our specialized cardiology team to provide comprehensive care for all your heart health needs.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>Find relief and expert care for digestive issues with our dedicated gastroenterology department at your service.</p>
                </div>
              </article>
            </div>
          </div>
